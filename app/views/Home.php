    ...
    <div id="home-slider" class="swiper home-swiper">
        <div class="swiper-wrapper">
            <picture class="swiper-slide">
                ...
                <img src="../../public/images/home/bg-header-home-1.jpg" alt="Intro 1" title="Home Slider 1">
            </picture>
            <picture class="swiper-slide">
                ...
                <img src="../../public/images/home/bg-header-home-2.jpg" alt="Intro 2" title="Home Slider 2">
            </picture>
            <picture class="swiper-slide">
                ...
                <img src="../../public/images/home/bg-header-home-3.jpg" alt="Intro 3" title="Home Slider 3">
            </picture>
            <picture class="swiper-slide">
                ...
                <img src="../../public/images/home/bg-header-home-4.jpg" alt="Intro 4" title="Home Slider 4">
            </picture>
        </div>
            ...
            <div>
                <div class="grid_img">
                    <picture>
                        ...
                        <img alt="" title="Vilkeer Projects Services 1" src="../../public/images/home/grid-services-1.jpg">
                    </picture>
                </div>
                <div class="grid_text">
            ...
            <div>
                <div class="grid_img">
                    <picture>
                        ...
                        <img alt="" title="Vilkeer Projects Services 2" src="../../public/images/home/grid-services-2.jpg">
                    </picture>
                </div>
                <div class="grid_text">
            ...
            <div>
                <div class="grid_img">
                    <picture>
                        ...
                        <img alt="" title="Vilkeer Projects Services 3" src="../../public/images/home/grid-services-3.jpg">
                    </picture>
                </div>
                <div class="grid_text">
